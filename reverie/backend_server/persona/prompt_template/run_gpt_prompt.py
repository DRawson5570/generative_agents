...
# Ensure a module-level 'debug' symbol exists (helps static analysis and avoids
# NameError when code references 'debug' through star imports in some setups).
# Keep a single debug definition; the module may also set a `debug` in globals.
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False):
    ...
    def __func_validate(gpt_response, prompt=""):
        try:
            ...
            import logging
            logging.exception("run_gpt_prompt validate failed")
            return False
        return True
...
def run_gpt_prompt_daily_plan(persona, wake_up_hour, test_input=None, verbose=False):
    ...
    def __func_validate(gpt_response, prompt=""):
        try:
            ...
            import logging
            logging.exception("run_gpt_prompt_daily_plan validate failed")
            return False
        return True
...
def run_gpt_prompt_pronunciatio(action_description, persona, verbose=False):
    ...
    def __func_validate(gpt_response, prompt=""):
        try:
            ...
            import logging
            logging.exception("run_gpt_prompt_pronunciatio validate failed")
            return False
        return True
    ...
    def __chat_func_validate(gpt_response, prompt=""):  ############
        try:
            ...
            import logging
            logging.exception("run_gpt_prompt_pronunciatio chat validate failed")
            return False
        return True
        return True
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False):
    ...
    def __func_validate(gpt_response, prompt=""):
        try:
            ...
            import logging
            logging.exception("run_gpt_prompt_event_triple validate failed")
            return False
        return True
